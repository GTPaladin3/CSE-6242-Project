...
def recommend_songs(energy, mood, input_song):
    clustering_algorithm = ClusteringAlgorithm()
    filtered_songs = clustering_algorithm.get_song_clusters(energy, mood, input_song)
...
def main():
    ...
    if st.button("Recommend Songs"):
        ...
        if input_song:
            ...
            recommended_songs = recommend_songs(x_axis, y_axis, None)
            # Get song information from Spotify API
            song_info = get_song_info_track_name(recommended_songs)
